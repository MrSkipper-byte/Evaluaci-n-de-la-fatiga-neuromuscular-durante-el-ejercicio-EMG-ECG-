...
3.  **Lanza la app**
    ...
    * Alternativamente, escribe en la ventana de comandos de MATLAB:
        ...
        AppBiopack
        ```
4.  La interfaz gráfica se abrira automáticamente.
...
* La app cargará las señales y armará los vectores de tiempo de forma automática basándose en una frecuencia de muestreo fija de $2000\text{ Hz}$ (fs = 2000).
...
* Gráficas en vivo: La pantalla muestra tres señales en constante actualización:
    1.  Ventana móvil de 2 segundos del ECG.
    2.  Ventana móvil de 2 segundos del EMG (ya filtrado y centrado).
    3.  La evolución segundo a segundo de la Frecuencia Mediana (MDF) calculada con STFT.
* ¿Cómo detecta la fatiga? Pasados los 8 segundos de calibración, el código cruza dos variables en tiempo real:
    1.  Que la MDF del EMG caiga por debajo del 75% de su valor base (indicador directo de fatiga muscular).
    2.  Que la frecuencia cardíaca (BPM) se mantenga por encima de las pulsaciones base.
